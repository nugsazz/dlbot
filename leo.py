...
cl = LINETCR.LINE()
cl.login(token='ElZBbWIXPJwDc70LTq74.T0FBeOXffror6l71ARUGfa.ihbr+7u5XWDoM3rrqaI1zuFwhoLOKEBEUh0R27EWLwY=')
cl.loginResult()

kk = LINETCR.LINE()
kk.login(token='ElX4dUfQa83r4lFbf576.qHP0BayhfdC6mbrhafqVnG./ySqJX6aiHD3PHDDTSnLgaxAkqv15L+z+TRgd0HJig4=')
kk.loginResult()

ki = LINETCR.LINE()
ki.login(token='EluGTh76oxvkOh8wNGM3.uoshoPrjsFNspwILVtE7iW.0SORSyepBRhwjAhwujuTC/kirMVuHggk31H/hqE0k7s=')
ki.loginResult()

kc = LINETCR.LINE()
kc.login(token='Eles18wekP0HrnAMo2X7.DpinUBiRtu1RdXpO6XFnbW.ZQYOuYAgDGtxfaaK9Gfl4i2TEZBZ3waogWi+DCkqQxc=')
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token='ElFjSpBzgdZWQIjvcFx8.ifJ42EC7SwiJ/xJoKzBBUa.r3XyGQwCwwyiFJY3u5EmocNXQxMJUKVe3qYPmDHxc34=')
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token='El4Oqmi5Fg40pXk8RkAa.lG/KS8lDPtvtGtvYGn2s2G.HymlGvHvrTpeEm900FpLJsITv3Qq+2kVBkmxKziew0I=')
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token='ElcdzQxYsLqLbFlP5q37.AeXf7+uBGgs68vfcfpKvbW.fg21bBfA+XriRqFMlyKyUWXPFQoHY6LOngbYaDvmbMM=')
kf.loginResult()

kg = LINETCR.LINE()
kg.login(token='El4YCde4QimOJm2SAeRa.15d9ctQj1EABziIL7zMY2G.ySQ+mRvQ+mc1Z9i+FX7fgkLSzC6RjfaDWq/nsc5Dt5Q=')
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token='ElxtR2hFLRWFoPqazpsb.qF1zgh6aQ0IFXqsh9EV2cW.tfO5vFxiUt/QCJ6rHDuvgqIrZwSBAVmaL39/ml539Sg=')
kh.loginResult()

kj = LINETCR.LINE()
kj.login(token='ElHBOvkStEnFVo1cqux6.Zf/Cr7UM9/PSEw3YK5MALG.N5heoHZBQJUPcfJBg11IS2Vqi8ddOf6yCT5Nji6InbM=')
kj.loginResult()

kl = LINETCR.LINE()
kl.login(token='El8Vd02YXyhM9k7RuRKe.NXYKCexUUAy1XDGI6+RwJG./H5qswOCWlxsi7n8CmNRRgvMJ0IWVfn/JFd/LMiBg54=')
kl.loginResult()
			...
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                if wait["contact"] == False:
                    ...
                    wait["contact"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Mode Cek Kirim Kontak Mati")
                    else:
                        cl.sendText(msg.to,"done")
